...
import { TrendUp, Timer1, Chart2, PercentageSquare } from 'iconsax-react';
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard icon={PercentageSquare} label="Hal qilish darajasi" value="94.6%" delta={2.4} tint="#3b82f6" index={1} />
      ...
      <Card className="mt-5">
        ...
        <div className="h-64 p-3">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={HOURLY_ACTIVITY} margin={{ top: 10, right: 12, left: -16, bottom: 0 }}>
              <defs>
