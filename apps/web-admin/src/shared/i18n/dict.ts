...
export const DICT: Record<Lang, Dict> = {
  uz: {
    ...
    "settings.profile.comingSoonFull": "Tez orada mavjud bo'ladi",
    ...
    "settings.security.comingSoon": "Tez orada",
    ...
    "settings.system.uptimeLabel": "Ishlash vaqti",
    "settings.system.uptimeLessThanMinute": "1 daqiqadan kam",
    "settings.system.uptimeHoursSuffix": "soat",
    "settings.system.uptimeMinutesSuffix": "daqiqa",
    ...
    "settings.system.cacheClearedMessage": "Kesh muvaffaqiyatli tozalandi",
  },
  ru: {
    "app.org": "Хокимият",
    ...
    "settings.profile.comingSoonFull": "Скоро будет доступно",
    ...
    "settings.security.comingSoon": "Скоро",
    ...
    "settings.system.uptimeLabel": "Время работы",
    "settings.system.uptimeLessThanMinute": "Менее 1 минуты",
    "settings.system.uptimeHoursSuffix": "ч.",
    "settings.system.uptimeMinutesSuffix": "мин.",
    ...
    "settings.system.cacheClearedMessage": "Кэш успешно очищен",
  },
  en: {
    "app.org": "Hokimiyat",
