...
void main() {
  ...
  Future<void> pumpWithState(
    WidgetTester tester,
    FaceState state, {
    Duration pumpDuration = const Duration(seconds: 2),
  }) async {
    ...
    // `FaceScanOverlay` ichida cheksiz takrorlanuvchi "nafas olish"/
    // skaner-chiziq animatsiyalarini ishlatadi, shuning uchun hech qachon
    // "settle" bo'lmaydi. Buning o'rniga soatni bitta pump'da yetarlicha
    // oldinga suramiz.
